...
public class AimNRangeReefLeftCommand extends Command {
  ...
  public boolean isFinished() {
    return (
      ...
      botPoseTargetSpace[2] < VisionConstants.kRangeReefLeftThresholdMax
      && botPoseTargetSpace[2]  > VisionConstants.kRangeReefLeftThresholdMin
      
      // Aim (Angle)
      && botPoseTargetSpace[4]  < VisionConstants.kAimReefLeftThresholdMax
      && botPoseTargetSpace[4]  > VisionConstants.kAimReefLeftThresholdMin

      // Strafe (Left Right Positioning)
      && botPoseTargetSpace[0]  < VisionConstants.kStrafeReefLeftThresholdMax
      && botPoseTargetSpace[0]  > VisionConstants.kStrafeReefLeftThresholdMin)
